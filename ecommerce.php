...
$link = mysqli_connect('localhost', 'root', '', 'kuliah_webservice_kedua');
...
if (strcmp($data, 'data') ==0) {
 ...
 case 'GET':
    ...
    echo "select * from ecommerce ";break;
    }
    else
    {
         $sql = "select * from ecommerce where id='$id'";
         echo "select * from ecommerce where id='$id'";break;
...
if ($method == 'POST') {
		...
		$querycek = "SELECT id,nama,produk,harga FROM ecommerce WHERE id ='$id'";
